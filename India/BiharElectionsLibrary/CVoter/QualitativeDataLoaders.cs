...
{
    public class QualitativeDataLoaders
    {
        ...
        public static Dictionary<int, Dictionary<PoliticalParty, Dictionary<PoliticalPartyParameter, int>>> BuildPartyParametersDataFromFile(string filename)
        {
            ...
            string candidateDataFilename)
        {
            ...
            var partyParametersData = BuildPartyParametersDataFromFile(partyParametersFilename);
            var developmentRatingsData = BuildDevelopmentRatingsDataFromFile(developmentIssuesFilename);
            var localIssueRatingsData = BuildLocalIssueRatingsDataFromFile(localIssuesFilename);
            var candidateRatingsData = BuildCandidateRatingsFromFile(candidateDataFilename);
