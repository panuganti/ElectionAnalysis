...
module Controllers {
    export class DataLoader {
        ...
        private _results2015Json: string = "json/predictions2015.json";
        ...
        getAllAssemblyConstituencies(): ng.IPromise<AC[]> {
            let deferred = this.q.defer();
            if (this._acs !== null) { deferred.resolve(this._acs);}
            this.http.get(this._allACsJson, this.headers).success((data) => deferred.resolve(data));
